...
detector configuration, comparing the use of teflon and no teflon
in front of the tracking plane.
"""
...
plt.legend()
plt.savefig(outdir+'erest_'+'sipm.png')
plt.close()
...
plt.legend()
plt.savefig(outdir+'erest_'+'sipm_fwhm.png')
plt.close()
...
plt.legend()
plt.savefig(outdir+'erest_'+'sipm_mean.png')
plt.close()
...
plt.legend()
plt.savefig(outdir+'erest_coverage'+'sipm.png')
plt.close()
...
plt.ylabel('SiPM FWHM')
plt.legend()
plt.savefig(outdir+'erest_coverage'+'sipm_fwhm.png')
plt.close()
...
plt.ylabel('SiPM Mean')
plt.legend()
plt.savefig(outdir+'erest_coverage'+'sipm_mean.png')
plt.close()
